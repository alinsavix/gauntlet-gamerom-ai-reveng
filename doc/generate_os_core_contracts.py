...
ROWS = (
    ...
    (0x03A0, "normal_boot", "Start the full destructive test of video-RAM spare before the normal boot continuation chain", "void", "no return", "early-boot tail entry; installs A4 continuation", "43f900904000"),
    ...
    (0x061E, "selftest_boot", "Seed color RAM and start the short destructive video-RAM-spare test for self-test boot", "void", "no return", "early-boot tail entry; installs A4 continuation", "41f900910000"),
