...
CONTRACTS = (
 ...
 (0x5E7A6,"maze_place_object_types","uint8 object_type","D0.l = 1 when any matching type or type-3 slot exists, else 0","frameless; reads low byte of first stack slot at A7+0x1B after saving registers","Verified",("move.b 0x1b(a7), d2","addi.b 0xfd, d3","bsr.w 0x5e5d2","bsr.w 0x5f310","move.l d5, d0")),
 ...
 (0x5EA2E,"pf_isblankfloor","D0.w = x, D1.w = y","D0.l = -1 iff x is nonzero, picture is 0x8000, and object type is not 0x3F; else 0","register body; also entered by fall-through from 0x5EA26","Verified",("andi.w 0x1f, d0","cmpi.w 0x8000, (a0, d1.w)","cmpi.b 0x3f, d0","moveq 0xff, d0","moveq 0x0, d0")),
