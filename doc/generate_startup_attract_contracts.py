...
CONTRACTS = (
    ...
    (0x44DB4, "show_level_start_screen", "void", "void", "calls fixed draw_string service indirectly through A3 = 0x25A", "Verified", ("movea.l 0x25a, a3", "jsr 0x5fc4e.l", "movea.l 0x57360, a0", "movea.l 0x5737c, a0", "movea.l 0x573d4, a0")),
