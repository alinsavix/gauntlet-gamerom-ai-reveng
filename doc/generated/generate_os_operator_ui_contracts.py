...
ROWS = (
    ...
    (0x48B8, "display_text_set_cursor", "Draw one string at explicit coordinates and update the operator-UI cursor to its end", "column low byte; row low byte; string pointer", "void", "normal three-slot stack ABI", "4e56fff82f02122e"),
    ...
    (0x4966, "display_decimal_set_cursor", "Format an eight-digit zero-padded decimal, trim leading zeroes while retaining one digit, draw it at explicit coordinates, and update the cursor", "column low byte; row low byte; value long", "void", "normal three-slot stack ABI", "4e56fff648e73000"),
    ...
    (0x4C38, "init_operator_alpha_palette", "Copy the eight operator palette words at 0x6B8A into alphanumeric color entries 0-7 (0x910000-0x91000E) and clear playfield palette entry 0 at 0x910500", "void", "void", "normal stack ABI", "48e72020227c0091"),
