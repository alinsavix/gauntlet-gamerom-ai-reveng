...
CONTRACTS=(
 ...
 (0x4014C,"game_start","void","does not return","OS reset entry through JMP veneer 0x40000; initializes palette/profile pointers, sets SR=0x2300, and tail-jumps to g2mainloop","Verified",0x32,("move.l 0x910520, 0x904036.l","move.l 0x571da, 0x904042.l","move.w 0x2300, sr","jmp 0x42a66.l")),
 ...
 (0x42A66,"g2mainloop","void","does not return","one-time init followed by infinite VBLANK-semaphore dispatch loop","Verified",0x104,("link.w a6, 0xfffc","jsr 0x4327a.l","tst.w (a2)","clr.w (a2)","jsr 0x42d0a.l","jsr 0x4ae20.l","bra.w 0x42a7e")),
