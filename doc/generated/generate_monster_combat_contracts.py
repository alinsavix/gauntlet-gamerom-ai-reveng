...
CONTRACTS = (
    ...
    (0x41B16, "find_unused_shot", "D4.w initial doubled shot offset; A2 picture array", "D4.w selected doubled shot offset; Z set when both mob_picture[D4] and the word at 0x904926+D4 are zero", "BSR-only register entry", "Verified", ("tst.w (a2, d4.w)", "tst.w (a0, d4.w)")),
