...
def main() -> None:
    ...
    rom_path = here.parent.parent / "row76.bin"
    ...
    if args.run_check:
        loader = here.parent / "gauntlet_loader.r2"
        for _, target, name, _ in CALLS:
            ...
            result = subprocess.run(command, cwd=here.parent.parent, text=True, capture_output=True)
