...
CONTRACTS = (
    ...
    (0x51E80, "door_open_start", "uint16 packed_door_slot, uint16 player_index, uint16 door_object_type", "void", "normal stack; fills that player's two endpoint positions/directions and calls main_open_doors", "Verified", 0x12E, ("move.w 0xa(a6), d3", "move.w 0xe(a6), d2", "move.w 0x12(a6), d4", "cmpi.w 0x9d7c, (a0, d0.w)", "cmpi.w 0x9d3c, (a0, d0.w)", "cmpi.w 0xe, d4", "jsr 0x51fae", "jsr 0x5207c", "jsr 0x45c00", "rts")),
