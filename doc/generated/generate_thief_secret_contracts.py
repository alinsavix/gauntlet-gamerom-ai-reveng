...
CONTRACTS=(
 ...
 (0x54EC6,"secret_getname","void","void","normal stack; global winner/settings state; either initializes name entry or marks the winner complete and clears secret_player","Verified",0x122,("movea.l 0x904063, a2","movea.l 0x904aa4, a1","andi.l 0x2000, d0","move.b 0x20, (a0, d0.w)","move.b 0x41, (a1)","jsr 0x25a.l","jsr 0x218.l","jsr 0x200.l","jsr 0x142.l","move.b 0x2, (a0, d0.w)","move.b 0xff, (a2)","rts")),
)
