...
ROWS = (
    ...
    ("callable", 0x2F04, "draw_string", "Draw one NUL-terminated string at an alpha coordinate", "column byte; row byte; string pointer; color/style word", "D0.l=source bytes consumed including NUL", "normal API implementation", "4a7900904f0e"),
    ...
    ("callable", 0x3044, "write_alpha_char", "Write one character/tile plus attributes at an alpha coordinate", "column byte; row byte; character word; color/style word", "void", "normal API implementation", "7000"),
    ...
    ("callable", 0x31D2, "display_large_text", "Render mapped large-font glyphs for a chained descriptor: each character indexes the 128-byte glyph map at 0x34A2, and the resulting index selects the four-byte tile quad at 0x33D2", "descriptor pointer", "D0.l=total alpha-cell advance", "normal API implementation", "48e72038"),
