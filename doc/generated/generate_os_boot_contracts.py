...
ROWS = (
    (0x03B6, "selftest_boot_spare_test_done", "Handle full spare-RAM result and start color-RAM test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x03C4, "selftest_boot_spare_error_ack", "Wait for acknowledgement after spare-RAM error and resume color test", "inherited hardware switch/status state", "no ordinary return", "A4 continuation from error display", "33c000803100"),
    (0x0424, "selftest_boot_color_test_done", "Handle full color-RAM result and start playfield test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x04A4, "selftest_boot_playfield_test_done", "Handle full playfield-RAM result and start alpha test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x0512, "selftest_boot_alpha_test_done", "Handle full alpha-RAM result and start MOB test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x0582, "selftest_boot_mob_test_done", "Handle full MOB-RAM result and enter main initialization", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x0652, "normal_boot_spare_test_done", "Handle short spare-RAM result and start color test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x0660, "normal_boot_spare_error_resume", "Resume short diagnostics after spare-RAM error display", "inherited hardware status", "no ordinary return", "A4 continuation from error display", "33c000803100"),
    (0x067C, "normal_boot_color_test_done", "Handle short color-RAM result and start playfield test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x06A6, "normal_boot_playfield_test_done", "Handle short playfield-RAM result and start alpha test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x06D0, "normal_boot_alpha_test_done", "Handle short alpha-RAM result and start MOB test", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    (0x06FC, "normal_boot_mob_test_done", "Handle short MOB-RAM result and enter main initialization", "inherited D4.w=test status", "no ordinary return", "A4 continuation from memory tester", "4a44"),
    ...
    (0x0D3A, "game_descriptor_ram_test_done", "Restore descriptor-test state, display a failing address, and flag the boot error", "inherited D4.w=test status; A5=saved stack frame", "returns to game_descriptor_ram_test caller; sets D5.w=1 at 0x0D6E when the status is nonzero", "A4 continuation; restores another entry's saved registers", "4a44"),
