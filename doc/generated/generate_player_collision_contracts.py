...
CONTRACTS = (
    ...
    (0x425D0, "probe_up", "D2.w current offset, D3/D4 coordinates; A2/A3/A4 MOB arrays", "D1.w candidate offset; carry = blocked", "row-one offsets <= 0x7E compare the proposed full D4 V word with 0xF080 instead of reading row zero; otherwise may tail-branch to tile_lookup_core", ("cmpi.w 0x7e, d2", "move.w 0xf080, d0")),
