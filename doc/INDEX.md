...
and tables were “fully documented.” The current audit instead checks 322/322
...
- [generated/callable_contract_coverage.csv](generated/callable_contract_coverage.csv) — complete
  322-entry union mapping every canonical game-ROM callable entry to one or
...
- [generated/control_targets.csv](generated/control_targets.csv) and
  ...
  analyzed direct/indirect control-transfer sites for all 322 documented game
  entries plus 81 unique computed-dispatch destinations, including
...
- [generated/rom_byte_coverage.csv](generated/rom_byte_coverage.csv),
  ...
  report of the eight intentional overlapping table views, across 322 catalog
  rows over 321 distinct addresses (one deliberate aggregate/subview pair) and
  347 non-code flags; generated by
...
- [generated/ram_operands.csv](generated/ram_operands.csv) and
  ...
  reconciliation for all 322 documented game callable entries; generated by
...
- [generated/os_callable_contracts.csv](generated/os_callable_contracts.csv) and
  ...
  reject-on-gap union of 230 active entries: 168 implementation/shared roots,
  six bounded computed-dispatch cases, and all 56 byte-checked public API
  veneers; generated by `generated/generate_os_callable_coverage.py`.
- [generated/os_control_targets.csv](generated/os_control_targets.csv) and
  ...
  closure — 392 site/owner rows across 384 distinct control sites;
  generated by `generated/generate_os_control_target_report.py`.
...
- [generated/os_all_function_contracts.csv](generated/os_all_function_contracts.csv) and
  ...
  — complete 269-row ROM-wide union of 168 active roots, five active-image
  residue entries, 34 retained-module roots, six computed cases, and 56 API
...
- [generated/os_rom_regions.csv](generated/os_rom_regions.csv),
  ...
  byte-exact 64 KiB OS-ROM partition across 14 top-level regions, 42
  active/retained data subregions, and 33 contiguous instruction/data/fill
  segments with no unknown byte;
