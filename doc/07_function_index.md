...
| 0x438AE | `maze_new_level_setup` | New-level initialization hub: reset transient systems, select/decode the maze, build object and exit tables, and for secret mazes use challenge target table 0x57056 to replace matching generators with exits, clear the other eligible generators, and replace ordinary monsters with typed hidden potions |
