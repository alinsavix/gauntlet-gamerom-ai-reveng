...
ROWS = (
    (0x0A2C, "mem_test_short", "Run the short destructive zero-fill and high-bit walking-one/zero test", "A1=start; A2=end inclusive; A4=completion/failure continuation", "D4.w=0 success or 1 failure via JMP (A4)", "register entry; never RTS; A6 chains stages", "4286"),
    (0x0A42, "mem_test_short_walk_ones", "Schedule high-bit-first walking-one pass over zero base", "inherited A1/A2/A4; D4/D6 state", "continues through A6 or fails through A4", "A6 continuation entry", "33c000803100"),
    (0x0A52, "mem_test_short_walk_zeroes", "Schedule high-bit-first walking-zero pass over all-ones base", "inherited A1/A2/A4; D4/D6 state", "continues through A6 or fails through A4", "A6 continuation entry", "33c000803100"),
    ...
    (0x0A7A, "mem_test_full_walk_ones_highbit", "Schedule high-bit-first walking-one pass over zero base", "inherited A1/A2/A4; D4/D6 state", "continues through A6 or fails through A4", "A6 continuation entry", "4df900000a84"),
    (0x0A84, "mem_test_full_walk_zeroes_highbit", "Schedule high-bit-first walking-zero pass over all-ones base", "inherited A1/A2/A4; D4/D6 state", "continues through A6 or fails through A4", "A6 continuation entry", "4df900000a8e"),
    ...
    (0x0AA2, "mem_test_full_restore_ones_highbit", "Schedule high-bit walking-one pass that restores the zero base", "inherited A1/A2/A4; D4/D6 state", "continues through A6 or fails through A4", "A6 continuation entry", "4df900000aac"),
    ...
    (0x0AC2, "mem_test_full_restore_zeroes_highbit", "Schedule high-bit walking-zero pass that restores the all-ones base", "inherited A1/A2/A4; D4/D6 state", "continues through A6 or fails through A4", "A6 continuation entry", "4df900000acc"),
