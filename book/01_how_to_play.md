...
machine's best-known line of dialogue. Only a player's shot sets off a potion
on the floor; a monster projectile merely breaks a destructible potion. The
game announces the player-triggered effect. Both lessons tend to arrive within
