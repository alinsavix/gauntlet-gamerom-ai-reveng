...
only constructing a ``HostShell`` does -- so ``import gauntpy.host.shell``
...
imported here to compose the cabinet input boundary. Raw
...
from ..render.framebuffer import PygameFramebuffer
        ...
        *,
        ...
        try:
            ...
            raise PygameUnavailable(
                "gauntpy.host.shell.HostShell needs pygame (or pygame-ce). "
