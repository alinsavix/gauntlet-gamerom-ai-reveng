...
from .subsystems.exits import main_exit_move
...
from .subsystems.player_lifecycle import (
    main_handle_death,
    main_health_countdown,
    player_hurt_palette_vblank,
)
from .subsystems.players import main_move_players
...
from .subsystems.treasure_rooms import main_treasure_timer
